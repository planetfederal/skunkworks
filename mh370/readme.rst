...
The styles we needed to generate
***********************************
Styles have been created in both SLD and CSS, and uploaded to GeoServer. The airport style with the plane icon was created in QGIS and exported using the OpenGeo Suite QGIS plugin. the radar icon was created from scratch in inkscape and saved as an svg in order to to create scale-dependent render sizes. The remaining styles have been created manually and entered in the GeoServer web console.
